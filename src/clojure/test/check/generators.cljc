...
(def pos-int
  "Generates positive integers bounded by the generator's `size` parameter."
  nat)

(def neg-int
  "Generates negative integers bounded by the generator's `size` parameter."
  (fmap #(* -1 %) nat))

(def s-pos-int
  "Generates strictly positive integers bounded by the generator's `size` + 1"
  (fmap inc nat))

(def s-neg-int
  "Generates strictly negative integers bounded by the generator's `size` + 1"
  (fmap dec neg-int))
