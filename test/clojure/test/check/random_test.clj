...
(def gen-seed
  (let [gen-int (gen/choose 0 Int32/MaxValue)]                           ;;; Integer/MAX_VALUE
    (gen/fmap (fn [[s1 s2]]
...
#_(when (try (Class/forName "java.util.SplittableRandom")                             -- commented out -- evey Class/forName won't work for us
